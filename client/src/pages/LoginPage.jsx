  ...
  return (
    ...
    sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      flex flex-col gap-6 rounded-lg shadow-lg'>
          ...
          !isDataSubmitted && (
            <>
                ...
                <input onChange={(e)=>{setEmail(e.target.value)}} value={email}
                  ...
                  focus:outline-none focus:ring-2' placeholder='Email' required/>
                <input onChange={(e)=>{setPassword(e.target.value)}} value={password}
                  type="password" className='p-2 border border-gray-500 rounded-md
                  focus:outline-none focus:ring-2' placeholder='Password' required/>
        ...
        <button type='submit' className='py-3 bg-gradient-to-r from-purple-400 to-violet-500 text-white   cursor-pointer rounded-md'>
        ...
        <div className='flex flex-col gap-2'>
          {currState === "Sign up" ? (
            ...
            <p className='text-sm text-gray-600'>create account ? <span onClick={()=>{setCurrState("Sign up")}} className='font-medium text-violet-500 cursor-pointer'>click here</span></p>
          )}
        </div>
